...
import { unCheckAll } from "../Store/Slices/checkBox";
...
function Colum() {
  ...
  return (
    <>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 mt-1">
        <div
          onClick={() => dispatch(changeState("campaigns"))}
          class={`bg-[#FAFAFA] ${
            TabHandlerState.campaign_tab === true ? "active" : ""
          } px-3 flex cursor-pointer tab_buttons_container items-center rounded-xl`}
        >
          <svg
          ...
          {checkedColumnsState.campaigns.length === 0 ? (
            ...
            <span className="p-1 ml-auto px-3 rounded-full flex text-white bg-blue-500">
      ...
      <div className="flex flex-wrap mt-0 mb-1 items-center bg-white-200 w-full">
        <div className="w-full ">
          <div className="flex inline-flex space-x-20">
            <div className=" table_filter_button_container flex flex-wrap items-center">
              ...
              <b className="bg-[#E6E6E6] p-2 rounded-lg">Rules</b>
              <button className="bg-[#E6E6E6] p-2 rounded-lg">
                <svg
                  class="w-[9px] h-[20px]"
                  aria-hidden="true"
              ...
              <button className="bg-[#E6E6E6] p-2 rounded-lg">
                <svg
                  class="w-[15px] h-[20px] ml-3 text-gray-800 dark:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 20 16"
