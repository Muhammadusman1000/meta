...
import { generate_random } from "../utils/func";
...
function MainTable() {
  ...
  function GetAllCheckBoxComp() {
    if (
      getActiveTab() === "campaign_tab" &&
      checkedColumnsState.campaigns[0] === "all"
    ) {
      return (
        <>
          <input
      ...
      getActiveTab() === "ad_set_tab" &&
      checkedColumnsState.adSets[0] === "all"
    ) {
      return (
        <>
          <input
      ...
      getActiveTab() === "ads_tab" &&
      checkedColumnsState.ads[0] === "all"
    ) {
      return (
        <>
          <input
  ...
  return (
    <>
      <div
        ...
        className="relative border-gray-300  p-0 my-1 overflow-x-auto  max-[1280px]:w-[1100px] max-[1080px]:w-[800px] max-[800px]:w-[100%]  min-[1100px]:max-w-[1220px]  min-[1400px]:max-w-[1420px] "
      >
          ...
          <thead className="text-xs text-black [&_tr_th]:capitalize [&_tr_th]:text-base  uppercase bg-white">
            <tr className="">
              <th scope="col" className=" py-2 px-1">
                <div className="flex items-center justify-content-between">
                  ...
                  <label
                    ...
                    className="xl:text-[19px] font-semibold ms-2"
                  >
                    Off/On
                  </label>
                </div>
              ...
              <th
                ...
                className="  text-right border-l px-3 py-3 "
              >
                <div className="flex justify-content-center gap-x-1 flex-flex-nowrap items-center">
                  <FcInfo className="d-inline  " /> Result{" "}
                  <BiSolidDownArrow className="d-inline text-gray-300 text-xs " />
                </div>
              </th>
              {/* ================ Result Column end ===========  */}
              {/* ================ Reach Column Start ===========  */}
              <th scope="col" className="px-3 py-3 ">
                <div className="flex justify-content-center gap-x-1 flex-flex-nowrap items-center w-32">
                  Reach
                  ...
                  >
                      ...
                      <div className="flex items-center justify-content-between">
                        ...
                        {getActiveTab() === "campaign_tab" ? (
                          <input
                            ...
                            defaultChecked={
                              checkedColumnsState.campaigns.includes(e.id) ||
                        ...
                        {getActiveTab() === "ad_set_tab" ? (
                          <input
                            key={"id" + generate_random(3)}
                            defaultChecked={
                              checkedColumnsState.adSets.includes("all") ||
                              checkedColumnsState.adSets.includes(e.id)
                                ? true
                                : false
                            }
                            onChange={(event) => handleCheckBoxEvent(event, e)}
                        ...
                        {getActiveTab() === "ads_tab" ? (
                          <input
                            key={"id" + generate_random(3)}
                            defaultChecked={
                              checkedColumnsState.ads.includes(e.id) ||
                              checkedColumnsState.ads.includes("all")
                                ? true
                                : false
                            }
                            onChange={(event) => handleCheckBoxEvent(event, e)}
                        ...
                        <label
                          ...
                          className="flex items-center justify-content-between ml-2"
                        >
                          {/* ====================
                    ...
                    >
                      <div className="w-100 edit_options_container">
                        ...
                        <div className="editOptions w-100 flex flex-row gap-x-2 [&_button_edit_buttons_icons]:text-black  [&_button]:flex [&_button]:items-center [&_button]:text-xs  ">
                          <button className="hover:opacity-[0.5] ">
                            <CgLoadbarSound className="editBtnIcons text-base mr-1" />{" "}
                            View Chart
                          </button>
                          <button className="hover:opacity-[0.5]">
                            <BiSolidPencil className="editBtnIcons mr-1" /> Edit
                          </button>
                          <button className="hover:opacity-[0.5]">
                            <BsPinAngleFill className="editBtnIcons mr-1" /> Pin
                          </button>
                        </div>
                      </div>
                    </td>
                    ...
                    {TabsState.campaign_tab === true ? (
                      <td style={{ borderLeft: "none" }} className="px-3">
                        <div className="w-100">
                          <h3 className="text-[#707070] text-right text-base font-normal">
                            Off
                          </h3>
                        </div>
                      </td>
                    ...
                    >
                      <div className="w-100">
                        <h3 className="text-[#272727] text-right text-base font-semibold">
                          {e.result}
                        </h3>
                        <h4 className="text-[#707070] font-semibold text-right text-{#707070;}text-xs mt-1">
                          On Facebook Leads
                        </h4>
                      </div>
                    </td>
                    ...
                    <td className="px-3 ">
                      ...
                      <h4 className="text-[#707070]  text-right font-light text-xs">
                        On Facebook Leads
                      </h4>
                    </td>
                    {/* ======= cost per result column End =====  */}
                    ...
                    <td className="px-3">
                      <h3 className="text-[#272727] text-right text-base font-semibold">
                        {e.budget}
                        <span>د۔ا</span>
                        <h4 className="text-[#707070] mt-1 text-right font-light text-xs">
                          Daily
                        </h4>
                      </h3>
                    </td>
                    ...
                    <td className="px-3">
                      <h3 className="text-black text-right text-base font-semibold">
                        {e.amount_spend}
                        <span>د۔ا</span>
                      </h3>
                    </td>
        ...
        <div className="table ">
          <div className="flex justify-between items-center">
            <h4 className="font-bold text-[20px] text-black flex items-center justify-center text-center w-1/4  ">
              Overall Leads & Spent
            </h4>
            <div className="flex  w-[60%]">
              <div className="border-0  truncate	ml-3 ">
                <h6 className="font-bold text-[20px] text-black text-end">
                  306
                </h6>
                <p className="text-[14px] font-semibold text-[#707070]">
                  Per Accounts Center a....
                </p>
              </div>
              <div className="pr-6 border-0 ml-3">
                <h6 className="font-bold text-[20px] text-black text-end">
                  766,797
                </h6>
                <p className="text-[14px] font-semibold text-[#707070]">
              ...
              <div className="pr-6 border-0	w-32 truncate">
                <h6 className="font-bold text-[20px] text-black text-end">
                  1.50
                </h6>
                <p className="text-[14px] font-semibold text-[#707070]">
                  Per On-Facebook Leads
                </p>
              </div>
              <div className="pr-6 border-0	ml-5">
                <h6 className="font-bold text-[20px] text-black text-end">
                  237.29د۔ا
                </h6>
                <p className="text-[14px] font-semibold text-[#707070]">
            ...
            <div className="pr-6 ">
              <h6 className="font-bold text-[17px] text-black border-0 pb-0">
                72,612.89د۔ا
              </h6>
              <p className="text-[13px] font-semibold text-[#707070] border-0 pb-0">
                Total Spent
              </p>
            </div>
          </div>
