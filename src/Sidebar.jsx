...
const Sidebar = (e) => {
  return (
    <nav
      className={`sidarBarcontainer ${e.sidebar === true ? "sidebarshow" : ""}`}
    >
      ...
      <div className="container w-[100%] flex flex-col rounded border-gray-50">
        ...
        <div className="m-3 mb-7 content-center">
          <span>
            {" "}
            <img className="m-2 w-7" src={group3} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-2 w-8" src={group31} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-2 w-7" src={group32} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-2 w-7" src={PeopleIcon} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-2 w-7" src={group9} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-2 w-7" src={group11} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-2 w-7" src={menuIcon} alt="Logo" />{" "}
          </span>
        </div>
        ...
        <div className="m-3 items-center">
          ...
          <span className="relative flex ">
            ...
            <span className="absolute -right-0 -top-1 span-red rounded-full pl-2">
              2
            </span>
          </span>
          <span>
            {" "}
            <img className="m-3 w-7" src={featherIcon} alt="Logo" />{" "}
          </span>
          <span className="relative flex ">
            <img className="m-3 w-7" src={bellIcon} alt="Logo" />
            <span className="absolute -right-0 -top-1 span-red rounded-full pl-1.5">
              25
            </span>
          </span>
          <span>
            {" "}
            <img className="m-3" src={searchIcon} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-3" src={questionIcon} alt="Logo" />{" "}
          </span>
          <span>
            {" "}
            <img className="m-3" src={bug} alt="Logo" />{" "}
          </span>
        </div>
