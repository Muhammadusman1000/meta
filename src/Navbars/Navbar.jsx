    ...
    <section className="w-full px-2">
      <div className="flex w-full gap-y-2 flex-wrap  bg-[#F2F2F2] py-3 px-4 lg:justify-between ">
        <div className="flex flex-wrap  items-center">
          ...
          <h4 className="text-[#3F3F3F] text:text-xl 2xl:text-[2xl] font-bold">
            Ad sets
          </h4>
        ...
        <div className="flex items-center flex-wrap gap-3">
          <p className="text-[#3F3F3F] font-semibold 2xl:text-[18px]">
            Updated just now
          </p>
          <div className="bg-[#E6E6E6] rounded-lg flex items-center justify-center py-3 px-4">
            <img
              src={refreshIcon}
              className="h-[11px] width: [14px] cursor-pointer"
              alt="refesh"
            />
          </div>
          <button className="bg-[#E6E6E6] text-[#3F3F3F] py-2 px-6 rounded-lg font-semibold 2xl:text-[18px]">
            Discard drafts
          </button>
          <button className="bg-[#1977F1] text-[#3F3F3F] py-2 px-6 rounded-lg text-white font-semibold 2xl:text-[18px]">
            Review and publish (2)
          </button>
          <div className="bg-[#E6E6E6] rounded-lg flex items-center justify-center py-3 px-4">
            <img
              src={dots}
              className="h-[16px] width:[16px] cursor-pointer"
              alt="refesh"
            />
          </div>
          <div className="bg-[#E6E6E6] rounded-lg flex items-center justify-center py-3 px-4">
            <img
              src={cross}
              className="h-[18px] width:[18px] cursor-pointer"
              alt="refesh"
            />
          </div>
        </div>
      ...
      <div className="bg-white  shadow-lg px-4 py-6 rounded-lg border-l-4 border-[#1977F1]">
        <div className="flex m-2 mx-3  items-start">
          <img
            src={informationIcon}
            className="h-[21px] width: [21px] mt-1"
            alt="refesh"
          />
          <div className="ps-4">
            <h6 className="font-bold 2xl:text-[18px]">
              Additional information
            </h6>
            <p className="2xl:text-[17px] font-semibold pt-[11px] pb-[13px]">
            ...
            <div className="flex gap-2">
              <button className="bg-[#F2F2F2] text-[#3F3F3F] rounded-lg py-2 px-3">
                Yes
              </button>
              <button className="bg-[#F2F2F2] text-[#3F3F3F] rounded-lg py-2 px-3">
                No
      ...
      <div className="shadow-lg w-full px-2 py-3">
        <div className="flex  max-[790px]:flex-wrap gap-2">
          ...
          <div className="">
            <select
              id="countries"
              class="max-[550px]:max-w-full max-[550px]:w-[100%]   bg-[#E6E6E6] border border-[#CECECE] text-[#3F3F3F] text-sm rounded-lg focus:outline-none p-2 "
            >
